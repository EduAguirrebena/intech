<!-- MODAL DIRECCION -->
<div class="modal fade text-left" id="direccionModal" tabindex="-1" role="dialog"
                  ...
                  <form id="direccionAddForm">
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" name="txtDir" id="txtDir" placeholder="Dir"
                                  class="form-control">
                          </div>
                          <div class="form-group">
                              <label for="txtNumDir">Número </label>
                              <input type="number" name="txtNumDir" id="txtNumDir" placeholder="Num"
                                  class="form-control">
                          </div>
                          <div class="form-group">
                              <label for="txtDepto">Depto </label>
                              <input type="text" name="txtDepto" id="txtDepto" placeholder="Depto/Bloque/Casa"
                                  class="form-control">
                          </div>
                          <div class="form-group">
                              <label for="txtcodigo_postal">Codigo postal </label>
                              <input type="text" name="txtcodigo_postal" id="txtcodigo_postal" placeholder="Código postal"
                                  class="form-control">
                          </div>
